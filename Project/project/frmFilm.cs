    ...
    public partial class frmFilm : Form
    {
        ...
        private void cbx_title_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = $"SELECT Film_ID FROM FILMS WHERE Title = '{cbx_title.SelectedValue}'  ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                adap.Fill(ds, "FILMS");
                cbx_filmID.ValueMember = "Film_ID";
                ...
                sql = $"SELECT Film_Cost FROM FILMS WHERE Title =  '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                ...
                sql = $"SELECT Selling_Price FROM FILMS WHERE Title = '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                ...
                sql = $"SELECT Length FROM FILMS WHERE Title =  '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                ...
                sql = $"SELECT Age_Restriction FROM FILMS WHERE Title =  '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                ...
                sql = $"SELECT Genre_ID FROM FILMS WHERE Title =  '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
                ...
                sql = $"SELECT Status FROM FILMS WHERE Title =  '{cbx_title.SelectedValue}' ";
                com = new SqlCommand(sql, conn);
                adap.SelectCommand = com;
